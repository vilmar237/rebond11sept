...
class OrganisationSettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $currency = Currency::where('currency_code', 'FCFA')->first();

        $setting = new Setting();
        $setting->company_name = 'Rebond';
        $setting->app_name = 'Rebond';
        $setting->company_email = 'mbia1378@gmail.com';
        $setting->company_phone = '695035506';
        $setting->address = 'Adresse de votre entreprise ici';
        $setting->website = 'https://rebond.com';
